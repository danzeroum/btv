...
//!    fixture (`btv_lsp_fixture`) como processo separado, registra as tools no
...
use btv_tools::lsp::{register_lsp_server, LspServerConfig};
use btv_tools::ToolRegistry;

fn fixture_server_config(root: &std::path::Path) -> LspServerConfig {
    LspServerConfig {
        id: "fixture".to_string(),
        command: env!("CARGO_BIN_EXE_btv_lsp_fixture").to_string(),
        args: vec![],
