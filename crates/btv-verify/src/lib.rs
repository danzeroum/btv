...
//! estruturados por ferramenta (ver `parsers`), o comando `btv verify`
//! (crates/btv-cli) escrevendo a evidência em disco, e o skill-vetter
...
mod tests {
    use super::*;
    use btv_schemas::verification::Verdict;
