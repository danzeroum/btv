...
//! não há "vet por default". Fica em Rust (não em `btv_review` Python) pra
...
use btv_schemas::verification::{Finding, Verdict, VerificationEvidence, VerificationStep};
...
pub struct SkillManifest {
    ...
    /// do `btv.toml` da Onda 2) — opcionais.
