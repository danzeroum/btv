...
//! de verdade fica em `crates/forge-sidecar/tests/python_sidecar.rs`.

use forge_proto::promptforge::prompt_forge_service_server::{
...
use forge_sidecar::SidecarClient;
...
impl PromptForgeService for MockPromptForge {
    ...
    async fn lint(
        &self,
        req: Request<forge_proto::promptforge::LintRequest>,
