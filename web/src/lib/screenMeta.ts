...
export const SCREEN_META: Record<ScreenId, ScreenMeta> = {
  onboarding: { kicker: 'setup', title: 'Primeiros passos', note: 'instalar · chaves de API · doctor', accent: 'var(--amber)', chromeIcon: '✦', chromeRight: 'btv init' },
  sessao: { kicker: 'btv run/chat', title: 'Sessão de código', note: 'transcript ao vivo', accent: 'var(--py)', chromeIcon: '▸', chromeRight: 'terminal' },
  permissao: { kicker: 'btv-core', title: 'Permissão interativa', note: 'não contornável', accent: 'var(--wire)', chromeIcon: '⚿', chromeRight: 'gate' },
  ...
  squad: { kicker: 'btv squad', title: 'Squad ao vivo', note: 'consenso ponderado · HITL', accent: 'var(--amber)', chromeIcon: '⧉', chromeRight: 'squad' },
  ...
  mcp: { kicker: '.btv/mcp.toml', title: 'Console MCP', note: 'sondagem ao vivo · política real', accent: 'var(--wire)', chromeIcon: '⎈', chromeRight: 'mcp' },
  ...
  experimentos: { kicker: 'experiment.v1', title: 'Experimentos A/B', note: 'teste z · dados semeados', accent: 'var(--py)', chromeIcon: '⚗', chromeRight: 'a/b' },
  ratelimit: { kicker: 'btv-llm', title: 'Rate limits', note: 'tetos configurados, não uso ao vivo', accent: 'var(--rust)', chromeIcon: '⏱', chromeRight: 'ratelimit' },
  sandbox: { kicker: 'bollard', title: 'Sandbox & skills de terceiro', note: 'confinamento real · read-only', accent: 'var(--amber)', chromeIcon: '⛨', chromeRight: 'sandbox' },
  lsp: { kicker: '.btv/lsp.toml', title: 'Language servers', note: 'declarado · lazy · zero probe', accent: 'var(--wire)', chromeIcon: '⌬', chromeRight: 'lsp' },
