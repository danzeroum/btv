...
// suíte — e o teardown daqui varre a descendência INTEIRA (ver `descendentes`
// abaixo), não só o `cargo run` filho: o sidecar Python vive em grupo de
// processo próprio e vazaria.
