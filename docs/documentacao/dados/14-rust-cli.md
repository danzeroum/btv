...
| `SquadTask{task_id,description,decision_type:"architecture",verification_evidence,model,roster,tenant_id:LOCAL,actor:"web:squad"}` | proto | saída/wire | `client.execute_task` | tag 4 `max_autonomy_level` removida (ADR 0033) |
...
| `SquadTask{task_id:"s{pid:x}",description,decision_type:"architecture",verification_evidence,model,roster:[],tenant_id:LOCAL,actor:"cli:squad"}` | proto | saída/wire | `client.execute_task` | tag 4 `max_autonomy_level` removida (ADR 0033) |
