...
`btv-store::LedgerStore`) como entrada de 1ª classe (`kind:
...
from btv_promptforge.hashing import canonical_json, sha256_hex
from pydantic import BaseModel

from btv_review.gates import ReviewVerdict
...
def evidence_hash(evidence: dict[str, Any]) -> str:
    ...
    (`btv_promptforge.hashing`: chaves ordenadas em todos os níveis,
