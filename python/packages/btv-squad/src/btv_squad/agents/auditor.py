...
`/verify` (Rust, `btv-verify`) — a `verification-evidence.v1` que o
`btv squad` roda sobre o workspace e anexa ao `SquadTask` antes de
...
(mesma filosofia de `btv_review/gates.py::evaluate` — regra dura
