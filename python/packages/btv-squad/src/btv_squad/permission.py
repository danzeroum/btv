...
class PermissionRequest(BaseModel):
    """Espelha `btv.core.v1.PermissionRequest` (`schemas/proto/core.proto`)."""
...
class PermissionDecision(BaseModel):
    """Espelha `btv.core.v1.PermissionDecision`."""
...
class PermissionClient(Protocol):
    ...
    `btv-core` em Rust. Testes usam `ScriptedPermissionClient`.
    """
